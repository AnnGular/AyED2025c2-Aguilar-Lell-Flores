...
#USANDO MONTICULOBINARIO

# class MonticuloBinario:
#     """Clase que implementa un montículo binario mínimo (min-heap) genérico. 
#     Permite almacenar elementos de cualquier tipo, priorizando el elemento con menor valor.
#     """

#     def __init__(self, cmp_func=None):
#         """
#         Inicializa un montículo mínimo vacío.
#         Se puede pasar una función de comparación opcional.
#         Si no se proporciona, se usa comparación por defecto.
#         """
#         self.data = []
#         self.cmp_func = cmp_func if cmp_func is not None else self.__default_cmp

#     def __default_cmp(self, a, b):
#         """Comparación por defecto: menor valor tiene mayor prioridad."""
#         return -1 if a < b else 1 if a > b else 0

#     def insertar(self, elemento):
#         """Inserta un elemento y ajusta hacia arriba para mantener la propiedad del min-heap."""
#         self.data.append(elemento)
#         self.__ajustar_hacia_arriba(len(self.data) - 1)

#     def extraer_min(self):
#         """Extrae y devuelve el elemento con mayor prioridad (menor valor)."""
#         if len(self.data) == 0:
#             return None
...
#     def __comparar(self, elemento1, elemento2):
#         """Usa la función de comparación personalizada o la por defecto."""
#         return self.cmp_func(elemento1, elemento2)
...
#     def mostrar(self):
#         """Imprime los elementos del montículo en su orden actual."""
#         if len(self.data) == 0:
#             print("Montículo vacío")
#         else:
#             for elemento in self.data:
